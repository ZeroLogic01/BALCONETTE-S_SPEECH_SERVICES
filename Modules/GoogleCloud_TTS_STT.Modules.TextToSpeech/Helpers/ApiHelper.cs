...
namespace GoogleCloud_TTS_STT.Modules.TextToSpeech.Helpers
{
    internal static class ApiHelper
    {
            ...
            float speakingRate, float pitch, string effectProfileId, SynthesisType synthesisType)
        {
            ...
            else
            {
              ...
              //  text = EncodeSpecialCharacters(text, "\"", "&quot;");
                ...
                synthesisInput.Ssml = $"<speak>{text}</speak>";
            }
        ...
        internal static string EncodeSpecialCharacters(string text, string toBeReplaced, string replacedWith,
            RegexOptions regexOptions = RegexOptions.Multiline)
        {
            var pattern = $"({toBeReplaced})(?![^<]*>|[^<>]*</)";
